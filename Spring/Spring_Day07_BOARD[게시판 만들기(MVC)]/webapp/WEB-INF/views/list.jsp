...
<body>
    <div class="container mt-5">
        ...
        onclick="location.href='/bulletinboard/writeform'">글쓰기</button>
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination justify-content-center">
               ...
               <li id="pre" class="page-item ${pageList.pre ? '' : 'disabled'} ">
                    <a class="page-link" href="/bulletinboard/list?requestPage=${pageList.startPage-5}" tabindex="-1">이전</a>
               </li>
             ...
             step="1" var="i">
             	...
             	<li class="page-item">
                <a class="page-link active" href="/bulletinboard/list?requestPage=${i}">${i}</a>
                </li>
             	</c:if>
             	
             	<c:if test="${pageList.currentPage ne i }">
             	<li class="page-item">
                	<a class="page-link " href="/bulletinboard/list?requestPage=${i}">${i}</a>
                </li>
             	</c:if>
             </c:forEach>
             ...
             <c:if test="${pageList.next}">
                <li class="page-item">
                    <a class="page-link" href="/bulletinboard/list?requestPage=${pageList.startPage+5}">다음</a>
                </li>
             </c:if> 
             </ul>
        </nav>
