...
if(totalPage > endPage) isNext=true;
    ...
    <ul class="pagination justify-content-center">
            ...
            %>
                <li id="pre" class="page-item disabled">
                    <a class="page-link" href="/list.jsp?requestPage=<%=requestPage-1%>" tabindex="-1">이전</a>
                </li>
            <% 
            //}
            if(isPre){
         ...
         // 요청할 페이지가 1 ~ 5 페이지를 초과할 경우
            ...
            <%}%>    
                ...
                %>
                	...
                	<a class="page-link" href="/list.jsp?requestPage=<%=i%>"><%=i%></a>
                	</li>
                <% 
                	}else{ // 같지 않을 경우
                %>
             ...
             <% if(isNext){ %>
                <li class="page-item">
                    <a class="page-link" href="/list.jsp?requestPage=<%=startPage+5%>">다음</a>
                </li>
            <%}%>
     </ul>
   </nav>
